...
//                ss << "parameter not equal to " << FILE_SIGNATURE_SIZE ;
    ...
    std::vector<unsigned char> ProjectIDGUIDdata4() const {
        return mProjectIDGUIDdata4;
    }
    void ProjectIDGUIDdata4(
        const std::vector<unsigned char>& pProjectIDGUIDdata4) {
    ...
    unsigned short FileCreationDayOfYear() const {
        return mFileCreationDayOfYear;
    }
    ...
    unsigned long NumberOfVariableLengthRecords() const {
        return mNumberOfVariableLengthRecords;
    }
    void NumberOfVariableLengthRecords(
        unsigned long pNumberOfVariableLengthRecords) {
    ...
    unsigned short PointDataRecordLength() const {
        return mPointDataRecordLength;
    }
    ...
    std::vector<unsigned long> NumberOfPointsByReturn() const {
        return mNumberOfPointsByReturn;
    }
    void NumberOfPointsByReturn(
        const std::vector<unsigned long>& pNumberOfPointsByReturn) {
        if (pNumberOfPointsByReturn.size() 
            == NUMBER_OF_POINTS_BY_RETURN_SIZE) {
